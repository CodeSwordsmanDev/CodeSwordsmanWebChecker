...
- 下载后直接双击 `majk-web-check-v1.0.2-win64-Setup.exe` 运行安装，无需额外配置
  Download and double-click `majk-web-check-v1.0.2-win64-Setup.exe` to install, no additional configuration required
...
## 📞 Contact / 联系我们
- Website: [https://www.majk.cn](https://www.majk.cn)
- GitHub: [https://github.com/CodeSwordsmanDev](https://github.com/CodeSwordsmanDev)
